...
const THEMES: Record<Theme, ThemeConfig> = {
  ...
  frutiger: {
    light: {
      ...
      background: 'hsla(130, 50%, 95%, 0.6)',
      card: 'hsla(130, 40%, 97%, 0.5)',
      muted: 'hsla(130, 30%, 90%, 0.5)',
      border: 'hsla(130, 20%, 85%, 0.5)',
      input: 'hsla(130, 20%, 88%, 0.5)',
      sidebarForeground: '215 25% 25%',
      sidebarAccent: 'hsla(130, 30%, 90%, 0.5)',
      sidebarAccentForeground: '215 25% 25%',
    },
    dark: {
      primary: '205 80% 60%',
      foreground: '205 50% 98%',
      background: 'hsla(140, 20%, 8%, 0.75)',
      card: 'hsla(140, 15%, 10%, 0.65)',
      muted: 'hsla(140, 10%, 15%, 0.6)',
      border: 'hsla(140, 10%, 20%, 0.5)',
      input: 'hsla(140, 10%, 20%, 0.6)',
      sidebarForeground: '140 20% 95%',
      sidebarAccent: 'hsla(140, 10%, 15%, 0.6)',
