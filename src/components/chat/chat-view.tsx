...
const AttachmentRenderer = ({ attachment, onPreviewImage, onMediaLoad }: { attachment: MessageAttachment, onPreviewImage: (url: string) => void, onMediaLoad: () => void }) => {
    ...
    switch (attachment.type) {
        case 'image': return <img src={mediaUrl!} onClick={() => onPreviewImage(mediaUrl!)} className="max-w-full max-h-[320px] w-auto object-contain rounded-lg cursor-pointer my-1" onLoad={onMediaLoad} />;
