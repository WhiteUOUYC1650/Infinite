          ...
          case 'privacy': return (
            <div className='p-2 space-y-1 divide-y animate-in fade-in slide-in-from-right-4 duration-300'>
              <SettingsSwitchItem 
                ...
                checked={!!currentUser.loginProtectionEnabled} 
              ...
              <div className='p-6 space-y-6 animate-in fade-in slide-in-from-right-4 duration-300'>
                  ...
                  <div className="grid gap-3">
                      <div className={cn("flex items-center gap-4 p-5 border rounded-3xl shadow-sm", glassEffect ? "glass-panel" : "bg-card")}>
                          <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary shrink-0"><FileSearch className="h-6 w-6" /></div>
                          <div className="flex-1">
                              <p className="font-black text-sm uppercase tracking-widest leading-none mb-1">{t('wn_mp3_tags_title')}</p>
                              <p className="text-[10px] text-muted-foreground font-medium leading-tight">{t('wn_mp3_tags_desc')}</p>
                          </div>
                      </div>
                      <div className={cn("flex items-center gap-4 p-5 border rounded-3xl shadow-sm", glassEffect ? "glass-panel" : "bg-card")}>
                          ...
                          <div className="flex-1">
                              <p className="font-black text-sm uppercase tracking-widest leading-none mb-1">{t('wn_music_comments_title')}</p>
                              <p className="text-[10px] text-muted-foreground font-medium leading-tight">{t('wn_music_comments_desc')}</p>
                          </div>
                      </div>
                      <div className={cn("flex items-center gap-4 p-5 border rounded-3xl shadow-sm", glassEffect ? "glass-panel" : "bg-card")}>
                          ...
                          <div className="flex-1">
                              ...
                              <p className="text-[10px] text-muted-foreground font-medium leading-tight">{t('wn_optimization')}</p>
                          </div>
                      </div>
                  </div>
              </div>
