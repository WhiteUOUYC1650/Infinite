export const translations = {
    en: {
      ...
      'admin_toast_cannot_delete_admin_desc': 'This protected account cannot be deleted.',
    ...
    ru: {
      ...
      'version_info': 'Вы используете версию 0.2.1 (Beta) мессенджера Infinite.',
      'ok': 'OK',
      ...
      'admin_toast_cannot_delete_admin_desc': 'Этот защищенный аккаунт не может быть удален.',
      ...
      'yellow': 'Желтый',
      'pink': 'Розовый',
      'frutiger_aero': 'Режим "Frutiger Aero"',
