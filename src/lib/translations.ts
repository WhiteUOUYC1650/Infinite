...
export const translations = {
    ...
    ru: {
      ...
      'faq_edit_profile_a': "Вы можете отредактировать свой профиль, нажав на свой аватар в нижней части боковой панели, что откроет вашу карто助ку профиля. Оттуда нажмите кнопку 'Редактировать профиль'. Вы также можете получить доступ к настройкам, нажав значок шестеренки и выбрав 'Профиль'.",
