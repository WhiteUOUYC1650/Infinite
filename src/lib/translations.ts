...
export const translations = {
    en: {
      ...
      'whats_new_forward_title': 'Forward Function',
      'whats_new_forward_desc': 'Quickly resend messages from one chat to another with all attachments.',
      'whats_new_minor_title': 'Minor Additions',
      'whats_new_minor_desc': 'Hide the Feed in settings, manually delete stories, and use smart internal links.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_forward_title': 'Функция «Переслать»',
      'whats_new_forward_desc': 'Быстро переотправляйте сообщения из одного чата в другой со всеми вложениями.',
      'whats_new_minor_title': 'Мелкие добавления',
      'whats_new_minor_desc': 'Скрытие Ленты в настройках, ручное удаление историй и поддержка умных внутренних ссылок.',
      'infvid_title': 'InfVid',
