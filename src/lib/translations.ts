export const translations = {
    en: {
      ...
      'edit_profile_desc': 'Change your display name. This will not change your unique @username.',
      'nickname_label': 'Nickname',
      'nickname_placeholder': 'Your new nickname',
      'cancel': 'Cancel',
      'save': 'Save',
      'saving': 'Saving...',
      'nickname_update_success': 'Your nickname has been updated.',
      ...
      'search_placeholder': 'Search by @username or /C/channel-link...',
    ...
    ru: {
      ...
      'edit_profile_desc': 'Измените свое отображаемое имя. Это не изменит ваше уникальное @username.',
      'nickname_label': 'Псевдоним',
      'nickname_placeholder': 'Ваш новый псевдоним',
      'cancel': 'Отмена',
      'save': 'Сохранить',
      'saving': 'Сохранение...',
      'nickname_update_success': 'Ваш псевдоним обновлен.',
      ...
      'search_dialog_desc': 'Находите пользователей, публичные группы или каналы.',
      'search_placeholder': 'Искать по @имени или /C/ссылке-канала...',
