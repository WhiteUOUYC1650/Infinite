...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Minor interface updates and stability fixes.",
      'whats_new_back_button_title': 'Back Button Support',
      'whats_new_back_button_desc': 'The system "back" button now intuitively navigates through settings and dialogs.',
      'whats_new_ui_title': 'Interface Improvements',
      'whats_new_ui_desc': 'Optimized layouts, more compact menus, and refined styles.',
      'whats_new_bug_fix_title': 'Fixes',
      'whats_new_bug_fix_desc': 'Fixed various issues, including the long-awaited return of message reactions.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_desc': "Минорное обновление интерфейса и исправления стабильности.",
      'whats_new_back_button_title': 'Поддержка кнопки «Назад»',
      'whats_new_back_button_desc': 'Системная кнопка «Назад» теперь интуитивно перемещает по настройкам и диалогам.',
      'whats_new_ui_title': 'Улучшения интерфейса',
      'whats_new_ui_desc': 'Оптимизированные макеты, более компактные меню и доработанные стили.',
      'whats_new_bug_fix_title': 'Исправления',
      'whats_new_bug_fix_desc': 'Исправлены различные ошибки, включая долгожданное возвращение реакций.',
      'infvid_title': 'InfVid',
