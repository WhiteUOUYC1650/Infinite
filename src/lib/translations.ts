...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Optimization and customization improvements.",
      'whats_new_legacy_title': 'Edition for Legacy Devices',
      'whats_new_legacy_desc': 'Created a special edition optimized for Android 4.1+ and old hardware.',
      'whats_new_font_title': 'System Font Support',
      'whats_new_font_desc': 'Added a toggle to use your system font globally for better readability and accessibility.',
      'whats_new_ui_title': 'Modern Glass Effects',
      'whats_new_ui_desc': 'Refined glassmorphism across all dialogs in experimental design.',
      'whats_new_optimization_title': 'Optimization for Older Android',
      'whats_new_optimization_desc': 'Improved performance and scroll smoothness on legacy devices (Android 5-7).',
      'infvid_title': 'InfVid',
      ...
      'faq_bot_prog_a': 'Creating bots in Infinite is done using visual logic blocks. You can set up auto-replies, work with variables, and conditions.',
      'open_full_guide': 'Open Full Guide',
      'bot_guide_title': 'Bot Programming Guide',
      'bot_guide_intro': 'Welcome to the Bot Studio guide. Here you will learn how to create your own autonomous assistants using logic blocks.',
      'bot_guide_events': 'Events (Triggers)',
      'bot_guide_event_start': '**On START Button**: Triggered when a user clicks the big START button in your bot chat.',
      'bot_guide_event_msg': '**When Message Received**: Triggered by every message sent to the bot.',
      'bot_guide_actions': 'Actions',
      'bot_guide_action_send': '**Send Message**: The bot sends a new message to the chat.',
      'bot_guide_action_reply': '**Reply**: The bot replies to the user\'s specific message.',
      'bot_guide_action_image': '**Send Image**: Sends an image by URL or Base64.',
      'bot_guide_logic': 'Logic',
      'bot_guide_logic_if': '**If**: Check a condition (e.g. if the message contains a certain word).',
      'bot_guide_logic_wait': '**Wait**: Pause execution for several seconds.',
      'bot_guide_vars': 'Memory (Variables)',
      'bot_guide_var_intro': 'Use curly braces to insert dynamic data into messages:',
      'bot_guide_var_user': '- `{user_name}`: Name of the user talking to the bot.',
      'bot_guide_var_msg': '- `{msg_text}`: Text of the received message.',
      'bot_guide_var_bot': '- `{bot_name}`: Your bot\'s name.',
      'bot_guide_var_time': '- `{time}`: Current server time.',
      'bot_guide_var_set': '**Set Variable**: Save custom data to bot memory. These variables are persistent for each user.',
      ...
      'admin_broadcast_desc': 'Send a message to ALL users from the official bot.',
      'admin_broadcast_label': 'Message Content',
      ...
      'use_system_font_label': 'Use System Font',
      'use_system_font_desc': 'Uses the default device font for better accessibility and familiarity.',
    ...
    ru: {
      ...
      'faq_invite_a': "To invite someone to a group you own, simply share the group's unique link (e.g., `/G/ваша-группа`) with them. When they open the link in the app's search, they will see an option to join your group.",
      ...
      'faq_media_a': "В полях ввода сообщения нажмите на иконку скрепки, чтобы открыть меню вложений. Оттуда вы можете выбрать 'Фото', 'Видео' или 'Музыка', чтобы выбрать файл с вашего устройства.",
      ...
      'whats_new_desc': "Улучшения оптимизации и кастомизации.",
      'whats_new_legacy_title': 'Издание для старых устройств (Legacy)',
      'whats_new_legacy_desc': 'Создано специальное издание, оптимизированное для Android 4.1+ и слабого железа.',
      'whats_new_ui_title': 'Современный эффект стекла',
      'whats_new_ui_desc': 'Доработан эффект стекла во всех окнах в экспериментальном дизайне.',
      'whats_new_optimization_title': 'Оптимизация под старые Android',
      'whats_new_optimization_desc': 'Повышена производительность и плавность скролла на устройствах с Android 5-7.',
      'whats_new_font_title': 'Поддержка системного шрифта',
      'whats_new_font_desc': 'Добавлен переключатель для использования вашего системного шрифта для лучшей читаемости.',
      'infvid_title': 'InfVid',
      ...
      'upload_story': 'Опубликовать историю',
      ...
      'story_expiration_desc': 'Выберите, как долго ваши истории будут видны.',
      'story_expiration_never': 'Никогда',
      'story_expiration_12 hours': '12 часов',
      'story_expiration_24 hours': '24 часа',
      'story_expiration_48 hours': '48 часов',
      'story_expiration_72 hours': '72 часа',
      ...
      'subscribe_prompt_desc': 'Подпишитесь на наш официальный канал, чтобы получать последние новости и обновления об Infinite.',
      'listener': 'Слушатель',
      ...
      'game_gold_clicker': 'InfGold Clicker',
      'game_gold_clicker_desc': 'Кликай, чтобы заработать InfGold! Каждые 100,000 кликов = 1 InfGold.',
      'game_upgrade_click_power': 'Улучшить клик',
      'game_upgrade_cost': 'Стоимость: {cost} кликов',
      'game_click_power': 'Сила клика: {power}',
      'send_gold': 'Отправить InfGold',
      'send_gold_desc': 'Введите количество InfGold, которое вы хотите отправить {name}.',
      'amount_label': 'Количество',
      'send_button': 'Отправить',
      'not_enough_gold_transfer': 'У вас недостаточно InfGold.',
      ...
      'poll_option_placeholder': 'Добавьте вариант',
      ...
      'poll_retract_vote': 'Отозвать голос',
      'show_prem_badge': 'Показывать значок Premium',
      'likes': 'Лайки: {count}',
      'feed_title': 'Лента',
      'feed_description': "Обновления из ваших каналов за сегодня",
      'no_feed_messages': 'На сегодня обновлений еще нет.',
      'forward': 'Переслать',
      'forward_message': 'Переслать сообщение',
      'forward_to': 'Переслать в...',
      'select_target_chat': 'Выберите чат для пересылки',
      'message_forwarded_success': 'Сообщение успешно переслано!',
      'show_feed_label': 'Отображать Ленту',
      'show_feed_desc': 'Показывать или скрывать кнопку Ленты в боковой панели.',
      'bot_studio_title': 'Bot Studio',
      'bot_studio_desc': 'Создавайте и программируйте собственных ботов с помощью визуальных блоков.',
      'create_bot': 'Создать бота',
      'my_bots': 'Мои боты',
      'edit_logic': 'Изменить скрипт',
      'block_event_received': 'При получении сообщения',
      'block_event_start': 'При нажатии СТАРТ',
      'block_action_send': 'Отправить сообщение',
      ...
      'no_studio_bots': 'Вы еще не создали ни одного бота.',
      'start_button': 'СТАРТ',
      ...
      'faq_bot_prog_a': 'Создание ботов в Infinite происходит с помощью визуальных блоков логики. Вы можете настроить автоответы, работу с переменными и условиями.',
      'open_full_guide': 'Открыть полный гид',
      'bot_guide_title': 'Гид по программированию ботов',
      'bot_guide_intro': 'Добро пожаловать в гид по Bot Studio. Здесь вы научитесь создавать собственных автономных помощников.',
      'bot_guide_events': 'События (Триггеры)',
      'bot_guide_event_start': '**При нажатии СТАРТ**: Срабатывает, когда пользователь нажимает кнопку START в чате с ботом.',
      'bot_guide_event_msg': '**При получении сообщения**: Срабатывает на каждое сообщение, отправленное боту.',
      'bot_guide_actions': 'Действия',
      'bot_guide_action_send': '**Отправить сообщение**: Бот отправляет новое сообщение в чат.',
      'bot_guide_action_reply': '**Ответить**: Бот отвечает на конкретное сообщение пользователя.',
      'bot_guide_action_image': '**Отправить фото**: Отправляет изображение по ссылке или Base64.',
      'bot_guide_logic': 'Логика',
      ...
      'bot_guide_var_set': '**Установить переменную**: Сохранение своих данных в память бота. Переменные уникальны для каждого пользователя.',
      'infvid_upload_warning_title': 'Идет загрузка...',
      'infvid_upload_warning_desc': 'Пожалуйста, не сворачивайте приложение и не блокируйте экран во время загрузки видео. Это гарантирует правильную обработку всех частей данных.',
      'birthday_label': 'День рождения',
      'birthday_banner_today': 'Сегодня день рождения {name}!',
      ...
      'admin_broadcast_desc': 'Отправить сообщение ВСЕМ пользователям от лица официального бота.',
      'admin_broadcast_label': 'Текст сообщения',
      'admin_broadcast_button': 'Начать рассылку',
      'admin_broadcast_success': 'Рассылка успешно отправлена {count} пользователям.',
      'admin_notify_update_label': 'Уведомить через Бота',
      ...
      'use_system_font_label': 'Использовать системный шрифт',
      'use_system_font_desc': 'Использует стандартный шрифт устройства для лучшей читаемости и привычного вида.',
      'android_9_plus_only': 'Android 9+',
      'whats_new_optimization_title': 'Оптимизация под старые Android',
      'whats_new_optimization_desc': 'Повышена производительность и плавность скролла на устройствах с Android 5-7.',
    }
