...
export const translations = {
    en: {
      ...
      'whats_new_stories_desc': 'Post photo stories for 24 hours! Completely free for all users, no Premium required.',
      'whats_new_holidays_title': 'Holiday Banners',
      'whats_new_holidays_desc': 'Dynamic banners appearing above your chats on important dates like Cosmonautics Day.',
      'whats_new_call_notifs_title': 'Call Notifications',
      'whats_new_call_notifs_desc': 'Global call alerts with ringtone support. Answer calls from anywhere in the app.',
      'whats_new_bugfixes_title': 'Bug Fixes & Improvements',
      'whats_new_bugfixes_desc': 'Fixed avatar compression on mobile, improved General Chat notifications, and optimized internal links.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_stories_desc': 'Публикуйте фото-истории на 24 часа! Полностью бесплатно для всех пользователей, подписка Premium не требуется.',
      'whats_new_holidays_title': 'Праздничные баннеры',
      'whats_new_holidays_desc': 'Динамические баннеры над чатами в важные даты (например, День космонавтики).',
      'whats_new_call_notifs_title': 'Уведомления о звонках',
      'whats_new_call_notifs_desc': 'Глобальные оповещения о звонках с поддержкой рингтона. Принимайте вызовы из любой части приложения.',
      'whats_new_bugfixes_title': 'Исправления багов',
      'whats_new_bugfixes_desc': 'Исправлено сжатие аватарок на мобильных, улучшены уведомления в Общем чате и оптимизированы внутренние ссылки.',
      'infvid_title': 'InfVid',
