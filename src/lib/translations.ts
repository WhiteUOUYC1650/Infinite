...
export const translations = {
    en: {
      ...
      'prem_benefit_3': 'Upload any file types',
      'prem_benefit_4': 'Large file uploads (up to 4GB)',
      'subscribe': 'Subscribe',
      ...
      'whats_new_title': "What's New in Version 0.3 Beta",
      'whats_new_desc': "First public version",
      'whats_new_infgold_title': 'InfGold & Subscriptions',
      'whats_new_infgold_desc': 'Introducing our own currency, InfGold! Earn it with the Daily Bonus. More features coming soon.',
      'whats_new_media_title': 'Media Sharing',
    ...
    ru: {
      ...
      'faq_infvid_q': 'Что такое InfVid и как им пользоваться?',
      ...
      'prem_benefit_3': 'Загрузка любых типов файлов',
      'prem_benefit_4': 'Большие файлы до 4 ГБ',
      ...
      'whats_new_desc': "Первая публичная версия",
      'whats_new_infgold_title': 'InfGold и подписки',
      'whats_new_infgold_desc': 'Представляем нашу собственную валюту — InfGold! Зарабатывайте её в ежедневном бонусе. Скоро появится больше возможностей.',
      'whats_new_media_title': 'Обмен медиафайлами',
      ...
      'whats_new_calls_desc': 'Оставайтесь на связи с помощью экспериментальных аудиозвонков один на один. Вы даже можете сворачивать окно звонка, чтобы продолжить пользоваться приложением.',
