export const translations = {
    en: {
      ...
      'version_info': 'You are currently running version 0.2.1 (Beta) of Infinite messenger.',
      'ok': 'OK',
    ...
    ru: {
      ...
      'version_info': 'Вы используете версию 0.2.1 (Бета) мессенджера Infinite.',
      'ok': 'OK',
