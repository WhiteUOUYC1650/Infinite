export const translations = {
    en: {
      ...
      'version_info': 'You are currently running version 0.1.2 (Beta) of Infinite messenger.',
      'ok': 'OK',
    ...
    ru: {
      ...
      'version_info': 'Вы используете версию 0.1.2 (Beta) мессенджера Infinite.',
      'ok': 'OK',
