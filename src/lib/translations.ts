...
export const translations = {
    ...
    ru: {
      ...
      'whats_new_holidays_title': 'Праздничные плашки',
      'whats_new_holidays_desc': 'Динамические баннеры над списком чатов, появляющиеся в важные даты (например, 12 апреля).',
