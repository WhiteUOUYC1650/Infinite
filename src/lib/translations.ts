...
export const translations = {
    en: {
      ...
      'whats_new_desc': "A major update focused on optimization, design, and better media experience.",
      'whats_new_media_captions_title': 'Media Captions',
      'whats_new_media_captions_desc': 'Now you can add descriptions (captions) to your photos, videos, music, and files. They will be displayed directly under the attachment.',
      'whats_new_bot_studio_title': 'Bot Studio 2.5',
      'whats_new_bot_studio_desc': 'Create powerful autonomous bots with persistent user memory and dynamic variables like {user_name}.',
      'whats_new_save_fix_title': 'Better Notifications',
      'whats_new_save_fix_desc': 'Notification titles now display the group name or the sender\'s nickname for better clarity.',
      'whats_new_minor_title': 'Optimization',
      'whats_new_minor_desc': 'Reduced battery usage and improved camera/mic handling during voice and video circle recording.',
      'whats_new_bug_fix_title': 'Smart Scrolling',
      'whats_new_bug_fix_desc': 'Fixed scrolling behavior: chats now open at the latest message while loading history seamlessly.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'faq_invite_a': "Чтобы пригласить кого-то в группу, которой вы владеете, просто поделитесь с ним уникальной ссылкой группы (например, `/G/ваша-группа`). Когда он откроет ссылку в поиске приложения, он увидит опцию присоединения.",
      ...
      'whats_new_title': "Что нового в версии 0.4.2 Beta",
      'whats_new_desc': "Масштабное обновление: оптимизация, дизайн и улучшенная работа с медиафайлами.",
      'whats_new_media_captions_title': 'Подписи к медиа',
      'whats_new_media_captions_desc': 'Теперь вы можете добавлять описания (подписи) к фото, видео, музыке и файлам. Они будут отображаться прямо под вложением.',
      'whats_new_bot_studio_title': 'Обновление Bot Studio 2.5',
      'whats_new_bot_studio_desc': 'Создавайте продвинутых ботов с поддержкой переменных ({user_name}) и сохранением памяти для каждого пользователя.',
      'whats_new_save_fix_title': 'Умные уведомления',
      'whats_new_save_fix_desc': 'В заголовках уведомлений теперь отображается название группы или никнейм собеседника для большего удобства.',
      'whats_new_minor_title': 'Оптимизация',
      'whats_new_minor_desc': 'Снижено энергопотребление и улучшена работа с камерой и микрофоном после записи голосовых и видео-сообщений.',
      'whats_new_bug_fix_title': 'Умный скролл',
      'whats_new_bug_fix_desc': 'Исправлено поведение прокрутки: чаты открываются на последнем сообщении, а история подгружается бесшовно.',
      'infvid_title': 'InfVid',
      ...
      'story_delete_confirm': 'Вы уверена, что хотите удалить эту историю?',
      ...
      'bot_guide_intro': 'Добро пожаловать в гид по Bot Studio. Здесь вы узнаете, как создавать собственных автономных помощников с помощью логических блоков.',
      'bot_guide_events': 'События (Триггеры)',
      'bot_guide_event_start': '**При нажатии СТАРТ**: Срабатывает, когда пользователь нажимает большую кнопку СТАРТ в чате с ботом.',
      'bot_guide_event_msg': '**Когда получено сообщение**: Срабатывает на каждое сообщение, отправленное боту.',
      'bot_guide_actions': 'Actions',
      'bot_guide_action_send': '**Отправить текст**: Бот отправляет новое сообщение в чат.',
      ...
      'admin_broadcast_desc': 'Отправить сообщение ВСЕМ пользователям от имени официального бота.',
