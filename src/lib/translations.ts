...
export const translations = {
    en: {
      ...
      'whats_new_desc': "A major update focused on optimization, design, and bot intelligence.",
      ...
      'whats_new_save_fix_title': 'UI Redesign',
      'whats_new_save_fix_desc': 'A more compact layout for tablets and desktop, featuring responsive sidebar and improved navigation.',
      'whats_new_minor_title': 'Optimization',
      'whats_new_minor_desc': 'Reduced battery usage and smoother animations with new staggered message rendering.',
    ...
    ru: {
      ...
      'whats_new_desc': "Масштабное обновление: оптимизация, дизайн и расширенные возможности ботов.",
      ...
      'whats_new_save_fix_title': 'Новый дизайн',
      'whats_new_save_fix_desc': 'Улучшенный макет для планшетов и десктопов с адаптивной шириной меню и быстрым доступом к функциям.',
      'whats_new_minor_title': 'Оптимизация',
      'whats_new_minor_desc': 'Значительно снижено потребление заряда батареи и улучшена плавность анимации сообщений.',
