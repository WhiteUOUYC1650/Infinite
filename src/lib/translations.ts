...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Major performance and UI updates.",
      'whats_new_back_button_title': 'Snappier UI',
      'whats_new_back_button_desc': 'Massive performance optimization. The app is now much smoother and uses less battery.',
      'whats_new_ui_title': 'New Reaction Menu',
      'whats_new_ui_desc': 'Quick reactions island is now layered above actions for faster access.',
      'whats_new_bug_fix_title': 'InfVid Fixes',
      'whats_new_bug_fix_desc': 'Video upload dialog is now centered and larger. Media attachments now use a dedicated popup.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_desc': "Крупное обновление интерфейса и скорости.",
      'whats_new_back_button_title': 'Быстрый интерфейс',
      'whats_new_back_button_desc': 'Оптимизирована отрисовка сообщений. Приложение стало плавнее и дольше держит заряд батареи.',
      'whats_new_ui_title': 'Плавающие реакции',
      'whats_new_ui_desc': 'Меню реакций теперь парит над списком действий, позволяя отвечать еще быстрее.',
      'whats_new_bug_fix_title': 'Исправлен InfVid',
      'whats_new_bug_fix_desc': 'Окно загрузки теперь полноэкранное и центрировано. Вложения в чате открываются через удобное окно.',
      'infvid_title': 'InfVid',
