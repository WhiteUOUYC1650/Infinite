...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Major bug fixes and security improvements.",
      'whats_new_back_button_title': 'Secure Server Time',
      'whats_new_back_button_desc': 'All messages now use server-side timestamps. This prevents time manipulation and ensures consistency across all devices.',
      'whats_new_ui_title': 'Fixed Polls & Replies',
      'whats_new_ui_desc': 'Voting in polls and replying to messages (including media) now works flawlessly.',
      'whats_new_bug_fix_title': 'Stability Patch',
      'whats_new_bug_fix_desc': 'Resolved a critical issue in the bot engine and layout engine that caused the app to crash.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_desc': "Масштабное исправление ошибок и улучшение безопасности.",
      'whats_new_back_button_title': 'Защищенное время',
      'whats_new_back_button_desc': 'Все сообщения теперь используют серверное время Firebase. Это исключает возможность подделки даты и гарантирует точность истории на всех устройствах.',
      'whats_new_ui_title': 'Починены опросы и ответы',
      'whats_new_ui_desc': 'Голосование в опросах и ответы на сообщения (включая медиафайлы) теперь работают безупречно.',
      'whats_new_bug_fix_title': 'Патч стабильности',
      'whats_new_bug_fix_desc': 'Устранена критическая ошибка в бот-движке и синтаксическая ошибка, приводившая к "белому экрану".',
      'infvid_title': 'InfVid',
