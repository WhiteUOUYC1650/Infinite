...
export const translations = {
    en: {
      ...
      'faq_infvid_q': 'What is InfVid and how to use it?',
      'faq_infvid_a': 'InfVid is our video sharing platform. You can upload videos, like them, and subscribe to authors. To upload, go to the InfVid tab and click the "+" button. Note that videos are limited to 10MB in the beta version.',
      'faq_security_v2_q': 'What is Cloud Password?',
      'faq_security_v2_a': 'Cloud Password provides extra security for your account. When enabled, you will be asked for this password during login. If you lose it, use your 8-digit Recovery Code or request a code from the official /B/Infinite bot.',
      ...
      'infinite_super': 'Infinite Super',
      'infinite_mega': 'Infinite Mega',
      'infinite_giga': 'Infinite Giga',
      'infinite_ultra': 'Infinite Ultra',
      'all_free_features': 'All free features',
      'all_features_from': 'All features from {tierName}',
      'super_feature_1': 'Custom emoji pack (soon)',
      'mega_feature_1': 'Larger file uploads (up to 1GB)',
      'giga_feature_1': 'Animated avatars and stickers (soon)',
      'ultra_feature_1': 'Highest priority support',
      'prem_feature_1': 'Unique profile badge',
      'prem_feature_2': 'Access to exclusive themes',
      'current_plan': 'Current Plan',
      'upgrade': 'Upgrade',
      'downgrade': 'Downgrade',
      'best_value': 'Best Value',
      'whats_new': "What's New",
      'whats_new_title': "What's New in 0.3 Beta",
      ...
      'welcome_legal_subtitle': 'Please review and accept the following documents before getting started.',
      ...
      'legal_accept_error': 'You must accept the terms to continue.',
    ...
    ru: {
      ...
      'faq_infvid_q': 'What is InfVid and how to use it?',
      'faq_infvid_a': 'InfVid — это наша платформа для обмена видео. Вы можете загружать ролики, ставить лайки и подписываться на авторов. Чтобы загрузить видео, перейдите во вкладку InfVid и нажмите кнопку "+". В бета-версии размер видео ограничен 10 МБ.',
      'faq_security_v2_q': 'Что такое Облачный пароль?',
      'faq_security_v2_a': 'Облачный пароль обеспечивает дополнительную защиту вашего аккаунта. Если он включен, мессенджер будет запрашивать этот пароль при входе. Если вы его забудете, воспользуйтесь 8-значным Кодом восстановления или запросите код у официального бота /B/Infinite.',
      ...
      'all_features_from': 'Все функции плана {tierName}',
      'super_feature_1': 'Пользовательский набор эмодзи (скоро)',
      'mega_feature_1': 'Увеличенный лимит загрузки файлов (до 1 ГБ)',
      'giga_feature_1': 'Анимированные аватары и стикеры (скоро)',
      'ultra_feature_1': 'Поддержка с наивысшим приоритетом',
      'prem_feature_1': 'Уникальный значок в профиле',
      'prem_feature_2': 'Доступ к эксклюзивным темам',
      'current_plan': 'Текущий план',
      'upgrade': 'Повысить',
      'downgrade': 'Понизить',
      'best_value': 'Выгодно',
      'whats_new': "Что нового",
      'whats_new_title': "Что нового в версии 0.3 Beta",
      ...
      'infvid_no_videos': 'Видео пока нет. Будьте первым!',
      ...
      'welcome_legal_title': 'Юридическая информация',
      'welcome_legal_subtitle': 'Пожалуйста, ознакомьтесь и примите следующие документы перед началом работы.',
