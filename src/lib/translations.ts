...
export const translations = {
    en: {
      ...
      'whats_new_title': "What's New in 0.5.0 Beta",
    ...
    ru: {
      ...
      'whats_new_title': "Что нового в версии 0.5.0 Beta",
      ...
      'bot_guide_var_set': '**Установить переменную**: Сохранить данные в память бота. Эти переменные сохраняются для каждого пользователя отдельно.',
