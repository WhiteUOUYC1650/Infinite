export const translations = {
    en: {
      ...
      'version_0_1_2_changes': 'Version 0.1.2 (Beta) - Performance\n- Improved message rendering performance.\n- Fixed an issue with avatar uploads.',
      'version_0_1_1_changes': 'Version 0.1.1 (Beta) - Themes\n- Added \'Frutiger Aero\' experimental theme.\n- Fixed minor visual glitches in the interface.',
    ...
    ru: {
      ...
      'version_0_1_3_changes': 'Версия 0.1.3 (Бета) - Обслуживание\n- Мелкие исправления ошибок и улучшения производительности.\n- Улучшена адаптивность интерфейса на разных размерах экранов.',
      'version_0_1_2_changes': 'Версия 0.1.2 (Бета) - Производительность\n- Улучшена производительность отрисовки сообщений.\n- Исправлена проблема с загрузкой аватаров.',
      'version_0_1_1_changes': 'Версия 0.1.1 (Бета) - Темы\n- Добавлена экспериментальная тема \'Frutiger Aero\'.\n- Исправлены мелкие визуальные недочеты в интерфейсе.',
