export const translations = {
    en: {
      ...
      'prem_benefit_1': 'Special badge in your profile.',
      'prem_benefit_2': 'Access to exclusive themes.',
      'prem_benefit_3': 'More features coming soon!',
      'subscribe': 'Subscribe',
      'subscribe_for_100': 'Subscribe for 100 InfGold',
      'already_subscribed': 'You are already subscribed',
      'not_enough_gold': 'Not enough InfGold to subscribe.',
      'subscription_successful_title': 'Congratulations!',
      'subscription_successful_desc': 'You have successfully subscribed to Infinite Prem.',
    ...
    ru: {
      ...
      'prem_benefit_1': 'Особый значок в вашем профиле.',
      'prem_benefit_2': 'Доступ к эксклюзивным темам.',
      'prem_benefit_3': 'Скоро будет больше функций!',
      'subscribe': 'Подписаться',
      'subscribe_for_100': 'Подписаться за 100 InfGold',
      ...
      'subscription_successful_desc': 'Вы успешно подписались на Infinite Prem.',
