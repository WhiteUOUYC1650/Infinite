...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Pervasive glass effects and older Android support.",
      'whats_new_back_button_title': 'Native Media Picker',
      'whats_new_back_button_desc': 'Attachments now open the system file picker directly for a faster experience.',
      'whats_new_ui_title': 'Modern Glass Effects',
      'whats_new_ui_desc': 'Experience a truly premium look with advanced glassmorphism in Experimental Design.',
      'whats_new_bug_fix_title': 'Android Optimization',
      'whats_new_bug_fix_desc': 'The app is now optimized for older Android versions (5-7) and more stable on low-end devices.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_desc': "Эффекты стекла и оптимизация под старый Android.",
      'whats_new_back_button_title': 'Системный выбор медиа',
      'whats_new_back_button_desc': 'Вложения теперь открывают системный выбор файлов напрямую, без лишних окон.',
      'whats_new_ui_title': 'Современный эффект стекла',
      'whats_new_ui_desc': 'Почувствуйте премиальный вид с продвинутым эффектом матового стекла в Экспериментальном дизайне.',
      'whats_new_bug_fix_title': 'Оптимизация под старые Android',
      'whats_new_bug_fix_desc': 'Приложение теперь оптимизировано для работы на старых версиях Android (5-7) и слабых устройствах.',
      'infvid_title': 'InfVid',
