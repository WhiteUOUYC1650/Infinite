...
export const translations = {
    en: {
      ...
      'game_gold_clicker_desc': 'Click to earn InfGold! Every 1000 clicks = 1 InfGold.',
    ...
    ru: {
      ...
      'game_gold_clicker_desc': 'Кликайте, чтобы заработать золото! Каждые 1000 кликов = 1 InfGold.',
