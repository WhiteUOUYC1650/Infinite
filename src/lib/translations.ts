...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Major performance and media updates.",
      ...
      'whats_new_ui_title': 'Improved InfVid Search',
      'whats_new_ui_desc': 'Search for videos by title, author, or direct link. Now available on all devices.',
      'whats_new_bug_fix_title': 'Stability Fixes',
      'whats_new_bug_fix_desc': 'Fixed InfVid link persistence and upload dialog centering. Optimized battery usage.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_desc': "Крупное обновление интерфейса и работы с медиа.",
      ...
      'whats_new_ui_title': 'Улучшенный поиск InfVid',
      'whats_new_ui_desc': 'Ищите видео по названию, автору или прямой ссылке. Доступно на всех устройствах.',
      'whats_new_bug_fix_title': 'Исправления стабильности',
      'whats_new_bug_fix_desc': 'Исправлено залипание ссылок в InfVid и центрирование окна загрузки. Оптимизирован расход батареи.',
      'infvid_title': 'InfVid',
