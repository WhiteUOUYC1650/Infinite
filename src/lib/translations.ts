...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Here are the latest features we've added:",
      'whats_new_infgold_title': 'InfGold & Subscriptions',
      'whats_new_infgold_desc': 'Introducing our own currency, InfGold! Earn it with the Daily Bonus and spend it on Prem subscriptions to unlock exclusive features.',
      ...
      'rustore_development': 'RuStore Subscriptions in development...',
      'rustore_note': 'We are currently integrating with RuStore billing. Premium features will be available soon.',
    ...
    ru: {
      ...
      'all_features_from': 'Все функции из {tierName}',
      ...
      'whats_new_desc': "Вот последние функции, которые мы добавили:",
      'whats_new_infgold_title': 'InfGold и подписки',
      'whats_new_infgold_desc': 'Представляем нашу собственную валюту — InfGold! Зарабатывайте её в ежедневном бонусе и тратьте на Prem-подписки, чтобы разблокировать эксклюзивные функции.',
      ...
      'rustore_development': 'Подписки для RuStore в разработке...',
      'rustore_note': 'Мы работаем над интеграцией платежей RuStore. Премиум-функции будут доступны совсем скоро.',
