...
export const translations = {
    en: {
      ...
      'whats_new_desc': "Security, stability and UI refinements.",
      'whats_new_back_button_title': 'Server Timestamps',
      'whats_new_back_button_desc': 'Messages now use secure server-side timestamps. Dates automatically adjust to your device timezone.',
      'whats_new_ui_title': 'Smart Scroll',
      'whats_new_ui_desc': 'A new 10-second guard ensures the chat stays at the bottom during slow nickname and media loading.',
      'whats_new_bug_fix_title': 'Fixed Replies',
      'whats_new_bug_fix_desc': 'Corrected the layout order in message bubbles. Sender name is now correctly positioned above reply previews.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_desc': "Приватность, стабильность и доработка интерфейса.",
      'whats_new_back_button_title': 'Серверное время',
      'whats_new_back_button_desc': 'Сообщения теперь используют защищенное серверное время. Дата и время подстраиваются под часовой пояс устройства.',
      'whats_new_ui_title': 'Умный скролл',
      'whats_new_ui_desc': '10-секундный «страж» удерживает чат внизу при медленной подгрузке никнеймов и медиа.',
      'whats_new_bug_fix_title': 'Исправленные ответы',
      'whats_new_bug_fix_desc': 'Скорректирован макет сообщений. Никнейм отправителя теперь правильно расположен над блоком ответа.',
      'infvid_title': 'InfVid',
      ...
      'no_comments_yet': 'No comments yet. Будьте первым!',
