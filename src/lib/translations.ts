...
export const translations = {
    ...
    ru: {
      ...
      'whats_new_bot_studio_title': 'Bot Studio 2.0',
      'whats_new_bot_studio_desc': 'Создавайте и программируйте собственных ботов с помощью визуальных блоков.',
      'whats_new_save_fix_title': 'Исправление сохранений',
      'whats_new_save_fix_desc': 'Исправлена проблема со сборкой и воспроизведением загруженных видео.',
      'whats_new_minor_title': 'Мелкие изменения',
      'whats_new_minor_desc': 'Улучшены элементы интерфейса и повышена стабильность боковой панели.',
