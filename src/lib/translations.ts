...
export const translations = {
    en: {
      ...
      'whats_new_cache_title': 'Local Storage',
      'whats_new_cache_desc': 'Media and files are now saved in your device memory for faster loading.',
      'whats_new_minor_title': 'Interface Update',
      'whats_new_minor_desc': 'Small design tweaks for better usability and cleaner look.',
      'whats_new_bug_fix_title': 'Bug Fixes',
      'whats_new_bug_fix_desc': 'Fixed login issues and member list displays.',
    ...
    ru: {
      ...
      'whats_new_cache_title': 'Локальное хранилище',
      'whats_new_cache_desc': 'Медиа и файлы теперь сохраняются в памяти устройства для быстрой загрузки.',
      'whats_new_minor_title': 'Обновление интерфейса',
      'whats_new_minor_desc': 'Небольшие улучшения дизайна для более удобного и чистого вида.',
      'whats_new_bug_fix_title': 'Исправления',
      'whats_new_bug_fix_desc': 'Исправлены проблемы со входом и отображением списков участников.',
