...
export const translations = {
    en: {
      ...
      'faq_transfer_a': 'Open your friend\'s profile by clicking their avatar in a chat. Then click the "Send Gold" button and enter the amount.',
      ...
      'whats_new_infgames_title': 'InfGames Platform',
      'whats_new_infgames_desc': 'Enjoy mini-games right inside Infinite! Earn real InfGold by playing.',
      'whats_new_transfers_title': 'Gold Transfers',
      'whats_new_transfers_desc': 'Send your InfGold to friends directly from their profile card.',
      'whats_new_polls_title': 'Interactive Polls',
      'whats_new_polls_desc': 'Create voting sessions in any chat with multiple choices and anonymity options.',
      'whats_new_bugfixes_title': 'Bug Fixes & UX',
      'whats_new_bugfixes_desc': 'Fixed redundant dialog buttons, optimized story layouts, and updated badge styles.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'faq_transfer_a': 'Откройте профиль друга, нажав на его аватар в чате. Затем нажмите кнопку «Отправить Gold» и введите сумму.',
      ...
      'whats_new_transfers_title': 'Переводы золота',
      'whats_new_transfers_desc': 'Отправляйте InfGold друзьям прямо через их карточку профиля.',
      'whats_new_polls_title': 'Интерактивные опросы',
      'whats_new_polls_desc': 'Создавайте голосования в любых чатах с выбором нескольких вариантов и анонимностью.',
      'whats_new_bugfixes_title': 'Исправления и интерфейс',
      'whats_new_bugfixes_desc': 'Удалены лишние кнопки в диалогах, оптимизировано отображение историй и обновлены значки.',
      'infvid_title': 'InfVid',
