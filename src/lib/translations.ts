...
export const translations = {
    en: {
      ...
      'whats_new_ui_title': 'Server Timestamps',
      'whats_new_ui_desc': 'Messages now use secure server-side timestamps. Dates automatically adjust to your local timezone.',
      'whats_new_bug_fix_title': 'Critical Fixes',
      'whats_new_bug_fix_desc': 'Resolved crashes in bot engine and corrected layout orders in reply previews.',
      'infvid_title': 'InfVid',
    ...
    ru: {
      ...
      'whats_new_ui_title': 'Серверное время',
      'whats_new_ui_desc': 'Сообщения теперь используют защищенное серверное время. Дата и время подстраиваются под часовой пояс устройства.',
      'whats_new_bug_fix_title': 'Критические исправления',
      'whats_new_bug_fix_desc': 'Устранены ошибки бот-движка и исправлен порядок элементов в превью ответов.',
      'infvid_title': 'InfVid',
