export const translations = {
    en: {
      ...
      'admin_badge': 'Admin',
      'admin_ban_user_confirm_desc': "This will anonymize the user {name} ({username}), replacing their profile data with 'Deleted Account'. Their authentication account will remain active, allowing them to still log in. This action is irreversible.",
    ...
    ru: {
      ...
      'admin_badge': 'Админ',
      'admin_ban_user_confirm_desc': "Это действие анонимизирует пользователя {name} ({username}), заменяя данные его профиля на 'Удалённый аккаунт'. Его учетная запись для входа останется активной. Это действие необратимо.",
