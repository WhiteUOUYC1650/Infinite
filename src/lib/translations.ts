...
export const translations = {
    ...
    ru: {
      ...
      'whats_new_legacy_title': 'Издание для старых устройств',
      ...
      'story_expiration_72 часа': '72 часов',
      ...
      'bot_guide_actions': 'Actions',
      'bot_guide_action_send': '**Send Message**: Бот отправляет новое сообщение в чат.',
      'bot_guide_action_reply': '**Reply**: Бот отвечает на конкретное сообщение пользователя.',
      'bot_guide_action_image': '**Отправить изображение**: Отправляет картинку по ссылке или в Base64.',
      'bot_guide_logic': 'Logic',
      'bot_guide_logic_if': '**If**: Проверка условия (например, если сообщение содержит определенное слово).',
      ...
      'use_system_font_desc': 'Использует шрифт, установленный в вашей системе, для лучшей читаемости.',
      'android_9_plus_only': 'Android 9+',
